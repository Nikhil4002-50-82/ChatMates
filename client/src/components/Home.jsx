...
//     let userToSelect;
//     const alreadyPresent = updatedChatUsers.some(
...
//       });
//       const newUser = { ...res.data, chatid };
//       updatedChatUsers = [...updatedChatUsers, newUser];
//       userToSelect = newUser;
//     } else {
//       updatedChatUsers = updatedChatUsers.map((u) =>
//         u.userid === otherUserId ? { ...u, chatid } : u
//       );
//       userToSelect = updatedChatUsers.find((u) => u.userid === otherUserId);
//     }
